...
class User extends \Auth\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Auth\\Entity\\User' . "\0" . 'id', '' . "\0" . 'Auth\\Entity\\User' . "\0" . 'username', '' . "\0" . 'Auth\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Auth\\Entity\\User' . "\0" . 'lastLogin', '' . "\0" . 'Auth\\Entity\\User' . "\0" . 'contents'];
        }
